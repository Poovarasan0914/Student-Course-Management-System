        ...
        <tr>
            <td align="center" style="padding: 40px 0;">
                <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    <!-- Header -->
                    <tr>
                        <td style="padding: 40px 40px 20px; text-align: center; background: linear-linear(135deg, #11998e 0%, #38ef7d 100%); border-radius: 12px 12px 0 0;">
                    ...
                    <tr>
                        <td style="padding: 30px 40px;">
                            ...
                            <!-- Course Details Card -->
                            <div style="padding: 25px; background: linear-linear(135deg, #f5f7fa 0%, #e4e8eb 100%); border-radius: 12px; border: 1px solid #e0e0e0;">
                                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                    <tr>
                            ...
                            <table role="presentation" style="width: 100%; border-collapse: collapse; margin-top: 30px;">
                                <tr>
                                    <td align="center">
                                        <a href="${dashboardUrl}" 
                                           style="display: inline-block; padding: 16px 40px; background: linear-linear(135deg, #11998e 0%, #38ef7d 100%); color: #ffffff; text-decoration: none; font-size: 16px; font-weight: 600; border-radius: 8px; box-shadow: 0 4px 15px rgba(17, 153, 142, 0.4);">
                                            Go to Dashboard
                                        </a>
                                    </td>
                                </tr>
